...
const BinanceReferral: React.FC = () => {
  ...
  return (
    <section className="glassmorphism p-6 rounded-lg shadow-2xl animate-fade-in h-full flex flex-col justify-between border border-yellow-500/40 bg-gradient-to-br from-yellow-500/5 to-transparent shadow-[0_0_15px_rgba(234,179,8,0.2)]">
      <div>
