...
const SupportProject: React.FC = () => {
  ...
  const qrCodeUrl = `https://api.qrserver.com/v1/create-qr-code/?size=150x150&data=${encodeURIComponent(qrData)}&bgcolor=161B22&color=e5e7eb&qzone=1`;
            ...
            <div className="flex-1 space-y-3 text-gray-300 w-full">
              ...
              <div className="space-y-1">
                ...
                <div className="flex items-center gap-2 bg-gray-800 p-2.5 rounded-lg">
                  <span className="font-mono text-lg text-cyan-300 flex-grow">{accountNumber}</span>
                  <button
                    onClick={handleCopy}
