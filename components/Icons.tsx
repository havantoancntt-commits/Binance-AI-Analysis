...
export const ArrowTrendingDownIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M2.25 6 9 12.75l4.286-4.286a11.948 11.948 0 0 1 5.884 5.516l2.74-1.22m0 0-5.94-2.28m5.94 2.28 2.28 5.941" />
    </svg>
);
...
export const RocketLaunchIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M15.59 14.37a6 6 0 0 1-5.84 7.38v-4.8m5.84-2.58a14.98 14.98 0 0 0 6.16-12.12A14.98 14.98 0 0 0 9.63 2.25a14.98 14.98 0 0 0-12.12 6.16.03.03 0 0 0 .02.05l3.52 4.36a1.125 1.125 0 0 1 .82 1.58l-1.46 2.32a1.125 1.125 0 0 0 1.58.82l4.36-3.52a.03.03 0 0 0 .05-.02Z" />
    </svg>
);

export const HandRaisedIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
      <path strokeLinecap="round" strokeLinejoin="round" d="M15.75 9V5.25A2.25 2.25 0 0 0 13.5 3h-6a2.25 2.25 0 0 0-2.25 2.25v13.5A2.25 2.25 0 0 0 7.5 21h6a2.25 2.25 0 0 0 2.25-2.25V15m-3 0-3-3m0 0-3 3m3-3V9" />
    </svg>
);
...
export const LightBulbIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M12 18v-5.25m0 0a6.01 6.01 0 0 0 1.5-.189m-1.5.189a6.01 6.01 0 0 1-1.5-.189m3.75 7.478a12.06 12.06 0 0 1-4.5 0m3.75 2.311a12.06 12.06 0 0 0-4.5 0m4.5 0a3.75 3.75 0 0 0-3.75-3.75m0 0a3.75 3.75 0 0 1 3.75-3.75m-3.75 3.75h.008v.008h-.008v-.008Zm0 3.75h.008v.008h-.008v-.008Zm0 3.75h.008v.008h-.008v-.008Z" />
  </svg>
);
...
export const CpuChipIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M8.25 3h7.5A2.25 2.25 0 0 1 18 5.25v13.5A2.25 2.25 0 0 1 15.75 21h-7.5A2.25 2.25 0 0 1 6 18.75V5.25A2.25 2.25 0 0 1 8.25 3Z M9 4.5v3.75m6-3.75v3.75m-3.75 0V3m0 18v-3.75M4.5 9h3.75m-3.75 6h3.75m11.25-6h-3.75m3.75 6h-3.75" />
  </svg>
);
...
export const ChatBubbleBottomCenterTextIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M12 20.25c4.97 0 9-3.694 9-8.25s-4.03-8.25-9-8.25S3 7.006 3 11.5c0 2.583 1.455 4.91 3.626 6.385.49.266.626.877.32 1.355-.305.478-.834.623-1.31.32A9.907 9.907 0 0 1 3 11.5c0-5.523 4.477-10 10-10s10 4.477 10 10-4.477 10-10 10z" />
    <path strokeLinecap="round" strokeLinejoin="round" d="M9 12h6m-3 3h.008v.008H12v-.008z" />
  </svg>
);
...
export const Cog6ToothIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
      <path strokeLinecap="round" strokeLinejoin="round" d="M9.594 3.94c.09-.542.56-1.008 1.11-1.226a11.95 11.95 0 0 1 2.59 0c.55.218 1.02.684 1.11 1.226.09.542-.146 1.111-.532 1.487a6.74 6.74 0 0 1-1.888 1.14l-.004.003c-.6.28-1.205.52-1.83.718-.624.198-1.28.324-1.95.324-2.3 0-4.34-.84-5.944-2.25l-.04-.032c-.386-.376-.622-.945-.532-1.487.09-.542.56-1.008 1.11-1.226a11.95 11.95 0 0 1 2.59 0Zm-2.18 11.458c.28.6.52 1.205.718 1.83l.003.004a6.74 6.74 0 0 1 1.14 1.888c.376.386.945.622 1.487.532.542-.09 1.008-.56 1.226-1.11a11.95 11.95 0 0 1 0-2.59c-.218-.55-.684-1.02-1.226-1.11-.542-.09-1.111.146-1.487.532a6.74 6.74 0 0 1-1.888 1.14l-.003.004c-.6.28-1.205.52-1.83.718-.198.624-.324 1.28-.324 1.95 0 .825.213 1.61.594 2.31l.032.04c.376.386.945.622 1.487.532.542-.09 1.008-.56 1.226-1.11a11.95 11.95 0 0 1 0-2.59c-.218-.55-.684-1.02-1.226-1.11-.542-.09-1.111.146-1.487.532a6.74 6.74 0 0 1-1.888 1.14l-.003.004c-.6.28-1.205.52-1.83.718Z" />
