...
export const HandRaisedIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
      <path strokeLinecap="round" strokeLinejoin="round" d="M7.5 9.75h9m-9 3h9m-9 3h3.375m-3.375-9.75V6.75c0-1.24 1.01-2.25 2.25-2.25h9c1.24 0 2.25 1.01 2.25 2.25v9.75c0 1.24-1.01 2.25-2.25 2.25h-3.375m-9.375-3.375c.348.632.933 1.125 1.594 1.458m3.542-.75a4.5 4.5 0 01-5.136-2.158" />
    </svg>
);
